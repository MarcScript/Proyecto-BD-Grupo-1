...
def listarEmpleados():
    ...
    list_emp = ttk.Treeview(top, column=("c1", "c2", "c3","c4","c5"), show='headings')
...
AgEmp = Button(ventana, text="Agregar Empleado", command=AgregarEmpleado,
               width=40, height=5, font="Times 12 italic bold")
AgEmp.place(x=height/6, y=50+k)

ListEmp = Button(ventana, text="Registro de Empleados", command=listarEmpleados,
               width=40, height=5, font="Times 12 italic bold")
            ...
            if UU_ID != None:
                ...
                if len(hora)==0:
                    ...
                    for row in result:
                        ...
                        print("cedula: ", row[2])
                        print("\n")
                        mensaje = " ID:{} \n Hora de entrada: {} \n Cédula:{}".format(row[0],row[1],row[2])
                        messagebox.showinfo(title="Registro Correcto ", message=mensaje)
                else:
...
>>>>>>> dd821e2465a754d06d264107d2820face7f2457c
